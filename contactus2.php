    ...
    <div class="container" >
        <div class="row">
            <div class="col-lg-6-m-auto">
                ...
                <h2 class="bg-primary text-white text-center py-3">Forms</h2>
                <hr>
            </div>
                <div class="card-body" >
                ...
                <button class="btn btn-primary"><a href="adminpage.php" style="text-decoration:none; color:white;">Back</a></button>
